...
"""
Different algorithms (random forest ensemble, graphical LASSO) to build
...
def GENIE3_single(em,gid,rids,tree_method,K,ntrees,max_depth,fo):
    ...
    seed = 131
    reg = SKLEARN_REGRESSOR_FACTORY[tree_method](random_state=seed,
                                                 n_estimators=ntrees,
