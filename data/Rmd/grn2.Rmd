...
Figure S8.  Different GRNs capture distinct parts of documented transcriptional regulations from Arabidopsis for the abscisic acid (ABA) pathway (A) and HY5 (Elongated Hypocotyl 5) regulated pathway (B).
...
Figure S11.  T-SNE clustering of 45 GRNs.  Top 500,000 TF-target predictions were extracted from each network to perform t-SNE clustering using parameter “perplexing=9, permutation=2000”. [interpret a bit more]
